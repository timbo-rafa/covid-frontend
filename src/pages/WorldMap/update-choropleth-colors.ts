...
export function updateChoroplethColors(map: mapboxgl.Map, columnValueByCountry: Record<string, number | null | undefined>) {
...
function getMatchExpression(columnValueByCountry: Record<string, number | null | undefined>) {
